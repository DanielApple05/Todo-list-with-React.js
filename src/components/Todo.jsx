...
const Todo = () => {
  ...
  return (
    <div className='max-w-12/12 relative'>
      <div className={` overflow-hidden bg-no-repeat flex place-content-center h-screen 
        ...
        <div className=' xl:max-w-5/12 w-full place-self-center xl:mt-4 mt-10 grid'>
          <div className='flex items-center xl:mt-7 mt-3 xl:mb-6 mb-15 justify-between xl:px-block px-5 fixed top-15 left-0 right-0'>
          ...
          <div className={`flex items-center xl:mb-10 mb-15 rounded-lg xl:mx-0 mx-5 fixed top-50 left-0 right-0 ${darkMode ? "bg-[#1e223c]" : "bg-white"}`}>
          ...
          <div className={`flex flex-col shadow-2xl xl:h-130 h-130 fixed top-80 w-full overflow-y-auto  `}>
