...
>
      ...
      <div className=' xl:max-w-5/12 w-full place-self-center xl:mt-70 mt-40 grid overflow-y-auto'>
        <div className={`flex flex-col shadow-2xl  w-full  ${darkMode ? "bg-[#1e223c]" : "bg-white"}`}>
